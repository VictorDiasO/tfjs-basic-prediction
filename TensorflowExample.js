...
const TensorflowExample = () => {
    ...
    return (
        <div className="tensorflow-project">
            <div className="train-controls">
                <h2 className="section">Dados para treino</h2>
                <div className="row-labels">
                    <div className="field-label column">Tempo (meses ou anos)</div>
                    <div className="field-label column">Faturamento (arredondado)</div>
                </div>
            ...
            <div className="predict-controls">
                <h2 className="section">Calculando...</h2>
                <input
